...
#PEERS_SAME_REGION = ['3.219.23.96','34.226.166.158','44.198.151.245','44.219.197.47','44.220.0.53','54.175.18.26']

# With public addresses (in two separate regions - last two servers in Oregon)
#PEERS_TWO_REGIONS = ['54.81.67.14','35.153.132.198','34.228.222.41','50.16.114.56','35.88.45.185','35.81.78.194']


PEER_UDP_PORT = 6789
PEER_TCP_PORT = 5679
N = 6   # Number of peers
SERVER_ADDR ='34.223.40.20'
SERVER_PORT = 5678
GROUPMNGR_ADDR = '35.95.245.241'
